...
**Customer Site**: https://[your-username].github.io/OLINGA/  
**Admin Panel**: https://[your-username].github.io/OLINGA/admin/
...
2. **Enable GitHub Pages** in your repository settings:
   ...
   - Branch: main/master
   - Folder: /root
3. **Wait for deployment** (GitHub Actions will automatically deploy)
4. **Access your site** at: `https://[your-username].github.io/OLINGA/`
